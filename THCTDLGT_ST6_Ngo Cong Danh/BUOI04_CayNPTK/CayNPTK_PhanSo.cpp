...
//		return 1;
//	}
//	// Tính giá trị tuyệt đối của tử số và mẫu số để so sánh
//	int currentVal = p->Info.tu * p->Info.mau;
//	int rootVal = root->Info.tu * root->Info.mau;
//
//	if (currentVal == rootVal)// TH2:Cây NPTK ko rỗng, bị trùng khoá
//		return 0;
//	else if (currentVal < rootVal)
...
//		return root;
//	else if (root->Info.tu * root->Info.mau > x.tu * x.mau)
...
//	if (root->Info.tu * root->Info.mau > x.tu * x.mau) {
//		showBSTNode(root);
...
//		return lc + rc + root->Info.tu * root->Info.mau;
//	}
//}
...
//		return root->Info.tu * root->Info.mau;
//	else {
...
//		return root->Info.tu * root->Info.mau + sumBSTNodeHaveOneChild(root->Left) + sumBSTNodeHaveOneChild(root->Right);
//	else
...
//		return root->Info.tu * root->Info.mau + sumBSTNodeHaveTwoChild(root->Left) + sumBSTNodeHaveTwoChild(root->Right);
//	else
