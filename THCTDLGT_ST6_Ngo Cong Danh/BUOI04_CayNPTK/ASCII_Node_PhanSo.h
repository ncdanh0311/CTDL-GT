#pragma once
#ifndef _ASCII_Node_PhanSo_h
#define _ASCII_Node_PhanSo_h
...
int MAX(int X, int Y);
//===============================================================================
asciinode* build_ascii_tree_recursive(BSTNode* t);
//Copy the tree into the ascii node structre
asciinode* build_ascii_tree(BSTNode* t);
